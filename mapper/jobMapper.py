...
def addJob(job):
    ...
    return sqlBase.execute_insert("insert into job (enable, remark, srcPath, dstPath, alistId, dstAlistId, useCacheT, "
                                  "scanIntervalT, useCacheS, scanIntervalS, method, copyType, processEnable, processTypes, processFind, processReplace, compareMode, interval"
...
def updateJob(job):
    ...
    sqlBase.execute_update("update job set enable=:enable, remark=:remark, srcPath=:srcPath, dstPath=:dstPath, alistId=:alistId, "
                           ...
                           "method=:method, copyType=:copyType, processEnable=:processEnable, processTypes=:processTypes, processFind=:processFind, processReplace=:processReplace, compareMode=:compareMode, interval=:interval, isCron=:isCron, year=:year, "
